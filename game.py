    ...
    def __init__(self, player_object):
        ...
        level = [
            # [x, y, width, height, sprite ]
                [893,527,217,50, grass],
                [639,741,297,44, grass],
                [804,370,218,53, grass],
                [959,876,126,15, grass],
                [77,154,344,35, grass],
                [182,269,96,147, grass],
                [278,305,90,112, grass],
                [484,213,172,45, grass],
                [2,967,1197,32, grass],
                [503,526,209,36, grass],
                [166,624,233,53, grass],
                [844,212,191,53, grass],
                [407,502,99,180, grass],
                [109,840,311,41, grass],
                [371,350,102,69, grass]
        ]
